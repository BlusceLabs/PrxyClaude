...
const ZAI_DEFAULT_BASE: &str = "https://api.z.ai/api/paas/v4";
...
impl Provider for ZAIProvider {
    ...
    async fn list_models(&self) -> Result<Vec<String>, ProviderError> {
        let client = reqwest::Client::new();
        let base = self.base_url.as_deref().unwrap_or(ZAI_DEFAULT_BASE);
        ...
        let mut models: Vec<String> = models_response
            ...
            .unwrap_or_default();
        models.push("glm-4.5-flash".to_string());
        models.push("glm-4.7-flash".to_string());
        Ok(models)
    }
