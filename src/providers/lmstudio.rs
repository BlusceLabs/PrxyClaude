...
impl LmstudioProvider {
    ...
    fn build_request_url(&self) -> String {
        self.base_url.as_deref().unwrap_or("http://localhost:1234").to_string() + "/v1/chat/completions"
    }
...
impl Provider for LmstudioProvider {
    ...
    async fn list_models(&self) -> Result<Vec<String>, ProviderError> {
        Ok(vec!["gpt-3.5-turbo".to_string(), "gpt-4".to_string(), "gpt-4-turbo".to_string()])
    }
