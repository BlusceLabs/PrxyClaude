...
def test_create_app_writes_server_log_under_prxy_home(monkeypatch, tmp_path):
    """App logging uses ~/.prxy/logs/server.log regardless of cwd."""
    ...
    assert canonical_log == tmp_path / ".prxy" / "logs" / "server.log"
