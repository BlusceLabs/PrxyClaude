...
class ConversationDriver:
    ...
    def ask(
        ...
        text: str,
        *,
        model: str = "proxycc-smoke-default",
        max_tokens: int = 256,
...
class ProviderMatrixDriver:
    ...
    def provider_smoke_models(self) -> list[ProviderModel]:
        ...
        if not models and os.getenv("PROXYCC_ALLOW_NO_PROVIDER_SMOKE") != "1":
            fail_missing_env(
                "no configured provider smoke models; set PROXYCC_ALLOW_NO_PROVIDER_SMOKE=1 "
    ...
    def adaptive_thinking_payload() -> dict[str, Any]:
        return {
            ...
            "messages": [
                ...
                {"role": "user", "content": "Reply with exactly PROXYCC_SMOKE_CLIENT"},
            ],
                    ...
                    "content": [
                        {
                            ...
                            "name": "echo_smoke",
                            "input": {"value": "PROXYCC_SMOKE_CLIENT"},
                        }
                    ],
                },
                {
