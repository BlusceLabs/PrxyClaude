...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="tokenrouter_api_key",
        secret=True,
        description=(
            "TokenRouter API key (OpenAI-compatible at api.tokenrouter.com/v1); "
            "see TokenRouter docs for available models."
        ),
    ),
    ConfigFieldSpec(
        "MODELSCOPE_API_KEY",
        ...
        secret=True,
        description=(
            "ModelScope API key (OpenAI-compatible at api-inference.modelscope.ai/v1); "
            "see ModelScope docs for available models."
        ),
    ),
    ConfigFieldSpec(
        "BAI_API_KEY",
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="tokenrouter_proxy",
        secret=True,
        advanced=True,
    ),
    ConfigFieldSpec(
    ...
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_NVIDIA_NIM",
        "Smoke NVIDIA NIM Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_OPEN_ROUTER",
        "Smoke OpenRouter Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_MISTRAL",
        "Smoke Mistral Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_MISTRAL_CODESTRAL",
        "Smoke Mistral Codestral Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_DEEPSEEK",
    ...
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_LLAMACPP",
        "Smoke llama.cpp Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_OLLAMA",
        "Smoke Ollama Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_KIMI",
        "Smoke Kimi Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_WAFER",
        "Smoke Wafer Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_OPENCODE",
        "Smoke OpenCode Zen Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_OPENCODE_GO",
        "Smoke OpenCode Go Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_ZAI",
        "Smoke Z.ai Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_FIREWORKS",
        "Smoke Fireworks Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_GEMINI",
        "Smoke Gemini Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_GROQ",
        "Smoke Groq Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_CEREBRAS",
        "Smoke Cerebras Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_MODEL_TOKENROUTER",
    ...
    ConfigFieldSpec(
        "PRXY_SMOKE_NIM_MODELS",
        "Smoke NIM Models",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "PRXY_SMOKE_NIM_EXTRA_MODELS",
...
def explicit_env_path() -> Path | None:
    """Return the explicit PRXY_ENV_FILE path, when configured."""

    if explicit := os.environ.get("PRXY_ENV_FILE"):
